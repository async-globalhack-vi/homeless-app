...
User.create!(email: "matt.a11@example.com", password: "pass")
User.create!(email: "matt.a12@example.com", password: "pass")
User.create!(email: "matt.a13@example.com", password: "pass")
User.create!(email: "matt.a14@example.com", password: "pass")
User.create!(email: "matt.a15@example.com", password: "pass")
User.create!(email: "matt.a16@example.com", password: "pass")
User.create!(email: "matt.a17@example.com", password: "pass")
User.create!(email: "matt.a18@example.com", password: "pass")
User.create!(email: "matt.a19@example.com", password: "pass")
User.create!(email: "matt.a20@example.com", password: "pass")
User.create!(email: "matt.a21@example.com", password: "pass")
User.create!(email: "matt.a22@example.com", password: "pass")
User.create!(email: "matt.a23@example.com", password: "pass")
User.create!(email: "matt.a24@example.com", password: "pass")
User.create!(email: "matt.a25@example.com", password: "pass")
User.create!(email: "matt.a26@example.com", password: "pass")
User.create!(email: "matt.a27@example.com", password: "pass")
User.create!(email: "matt.a28@example.com", password: "pass")
User.create!(email: "matt.a29@example.com", password: "pass")
User.create!(email: "matt.a30@example.com", password: "pass")
User.create!(email: "matt.a31@example.com", password: "pass")
User.create!(email: "matt.a32@example.com", password: "pass")
User.create!(email: "matt.a33@example.com", password: "pass")
User.create!(email: "matt.a34@example.com", password: "pass")
User.create!(email: "matt.a35@example.com", password: "pass")
User.create!(email: "matt.a36@example.com", password: "pass")
User.create!(email: "matt.a37@example.com", password: "pass")
User.create!(email: "matt.a38@example.com", password: "pass")
User.create!(email: "matt.a39@example.com", password: "pass")
User.create!(email: "matt.a40@example.com", password: "pass")
User.create!(email: "matt.a41@example.com", password: "pass")
...
AssistanceProvider.create!(
    ...
    email: "matt11.a@example.com",
    street_address: "3200 St. Vincent Avenue",
    city: "St. Louis",
    state: "MO",
    zip: "63104",
    max_monthly_contribution: "600",
...
AssistanceProvider.create!(
    ...
    email: "matt12.a@example.com",
    street_address: "4901 Forest Park Avenue",
    city: "St. Louis",
    state: "MO",
    zip: "63108",
...
AssistanceProvider.create!(
    name: "Bridgeway Behavoral Health",
    email: "matt13.a@example.com",
    street_address: "4066 Dunnica Ave.",
    city: "St. Louis",
    state: "MO",
    zip: "63116",
...
AssistanceProvider.create!(
    name: "Christ Lutheran Church of Washington",
    email: "joseph.hainline+CLC@gmail.com",
...
Event.create!(
    ...
    zip: "63091",
    event_type: "Overdue electric bill",
    notes: "Electric was cutoff today."
)
Event.create!(
    date_of_event: "10/16/2016",
    street_address: "680 Linden Lane",
    city: "Washington",
    state: "MO",
    zip: "63090",
